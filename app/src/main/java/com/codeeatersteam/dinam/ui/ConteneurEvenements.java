 ...
 * {@link ConteneurEvenements.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ConteneurEvenements#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ConteneurEvenements extends Fragment {
     ...
     * @return A new instance of fragment ConteneurEvenements.
     */
    // TODO: Rename and change types and number of parameters
    public static ConteneurEvenements newInstance(String param1, String param2) {
        ConteneurEvenements fragment = new ConteneurEvenements();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView=  inflater.inflate(R.layout.fragment_conteneur_evenements, container, false);
        mTabHost= (FragmentTabHost)rootView.findViewById(R.id.evenementtabhost);
        mTabHost.setup(getActivity(),getChildFragmentManager(),R.id.evenementtabcontent);
        mTabHost.addTab(mTabHost.newTabSpec("allevents").setIndicator("Tous les evenements"),Evenements.class,null);
        mTabHost.addTab(mTabHost.newTabSpec("myevents").setIndicator("Evenements pour moi"),EvenementsPourMoi.class,null);

        DbBuilder dbBuilder = new DbBuilder(rootView.getContext());

        fab = (FloatingActionButton) rootView.findViewById(R.id.fabevenements);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ouvrirActivite(view.getContext(), ProposerEvenement.class);
            }
        });
