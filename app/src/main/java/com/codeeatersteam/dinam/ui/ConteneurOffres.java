 ...
 * {@link ConteneurOffres.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ConteneurOffres#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ConteneurOffres extends Fragment {
     ...
     * @return A new instance of fragment ConteneurOffres.
     */
    // TODO: Rename and change types and number of parameters
    public static ConteneurOffres newInstance(String param1, String param2) {
        ConteneurOffres fragment = new ConteneurOffres();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView=  inflater.inflate(R.layout.fragment_conteneur_offres, container, false);
        mTabHost= (FragmentTabHost)rootView.findViewById(R.id.offretabhost);
        mTabHost.setup(getActivity(),getChildFragmentManager(),R.id.offretabcontent);
        mTabHost.addTab(mTabHost.newTabSpec("alloffres").setIndicator("Toutes les offres"),Offres.class,null);
        mTabHost.addTab(mTabHost.newTabSpec("myoffres").setIndicator("Offres pour moi"),OffresPourMoi.class,null);
        DbBuilder dbBuilder = new DbBuilder(rootView.getContext());

        fab = (FloatingActionButton) rootView.findViewById(R.id.faboffres);
